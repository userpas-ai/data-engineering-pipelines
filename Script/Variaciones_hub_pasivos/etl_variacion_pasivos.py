...
def actualizar_tabla_saldos(df, periodo_objetivo):
    nombre_tabla = "pla_variacion_pasivos"
    try:
...
if __name__ == "__main__":
    ...
    # 2. Leer la ruta desde el archivo .env
    ruta_base = os.getenv("OUTPUT_DIR")

    if not ruta_base:
        print("ERROR: La variable OUTPUT_DIR no está definida en el archivo .env")
        exit(1)
